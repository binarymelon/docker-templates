...
unRAID Docker Templates for Docker images in the "binarymelon" repository.
...
2. Enter in a URL of https://gitlab.com/binarymelon/docker-templates in the "Template repositories" field
